describe('Unit: googleAppsDocPluginContent: Services', function () {
  ...
  describe('Unit : DataStore Factory', function () {
    ...
    beforeEach(module('googleAppsDocPluginContent', function ($provide) {
  ...
  it('DataStore.save should exist and be a function', function () {
    ...
    it('DataStore.update should return success', function () {
      ...
      DataStore.update( 123, TAG_NAMES.GOOGLE_DOC_INFO, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
    ...
    it('DataStore.save should return success', function () {
      ...
      DataStore.save( 123, TAG_NAMES.GOOGLE_DOC_INFO, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
  })
